/**
 * AES-128-CFB secure frame encryption/decryption for LOCO protocol.
 * 
 * Frame format:
 *   [encrypted_size: 4 LE][iv: 16][ciphertext: N]
 *   - encrypted_size = 16 (iv) + ciphertext length
 */
...
/** Encrypt plaintext into a secure LOCO frame */
...
/** Decrypt a secure LOCO frame back to plaintext */
